...
@Component
public class DraftEmailToolExecutor implements AgentTool {

    private final EmailTool emailTool;
    private final AgentStateStore stateStore;

    public DraftEmailToolExecutor(EmailTool emailTool, AgentStateStore stateStore) {
    ...
    public AgentSessionState execute(AgentSessionState state, PlanStep step) {
        ...
        emailTool.draftEmail(new EmailToolRequest(
                state.sessionId(),
                recipient,
                subject
        ));
